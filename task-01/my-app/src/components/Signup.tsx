...
function Signup() {
  ...
  return (
    <div className='singup-container w-[100vw] h-[100%] flex sm:flex-row flex-col'>

        {/* Left Section  */}
        <div className='left-section w-1/2 text-white '>
        ...
        {/* Right Section */}
        <div className='right-section w-1/2  h-[900px] text-black flex flex-col items-center justify-center'>
