...
function Signup() {
  return (
    <div className='signup-container w-[100%] h-auto'> {/* Main Signup container Page*/}
      <div className='w-[100%] h-[100%]  flex lg:flex-row flex-col ' >
        <LeftSignup />  {/* Left section of signup page */}
        <RightSignup /> {/* Right section of signup page */} 
      </div>
    </div>
  )
}
