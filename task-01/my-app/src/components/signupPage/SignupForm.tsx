...
import google from "../../assests/images/googleLogo.png"

const initialValue = {  // Initial Values for UseFormik Hook
    firstName: '',
    lastName: '',
    email: '',
    password: '',
...
function SignupForm() {
    ...
    const signupFormData = useFormik( // SignUp form Data and all it's structure using useFormik hook 
        {
    ...
    const [confirmPasswordShow, setConfirmPasswordShow] = useState<boolean>(false); // Flag for Eye button on Confirmation Password field
    return (

        // Signup form main container 
        <div className='right-section w-full  text-[#101828] flex flex-col items-center justify-center gap-5 my-5 '>
            <h1 className='text-[28px] font-[600px] text-[#101828]  leading-[28px]  md:text-start text-center md:w-[400px] w-full'>
                Create an account
            </h1>

            <div className='md:w-[400px] w-full  h-[100%] flex flex-col  md:justify-start justify-center md:items-start items-center gap-[32px] pb-5 md:mt-0 mt-5 '>
                {/* Form container  */}
                <form onSubmit={signupFormData.handleSubmit} className=' flex flex-col gap-[16px] text-[#344054] w-[100%]'>

                    {/* First Name Field */}
                    <label className=' flex flex-col gap-[5px] text-[#344054] md:w-full w-[90vw] mx-auto'>
                        <p className='text-[16px] leading-[16px] font-[400px] '>
                            First Name
                    ...
                    <label className='flex flex-col gap-[5px] text-[#344054] md:w-full w-[90vw] mx-auto'>
                        ...
                        <input name='lastName' 
                            value={signupFormData.values.lastName}
                            onChange={signupFormData.handleChange}
                            onBlur={signupFormData.handleBlur}
                    ...
                    {/* Submit Button Field*/}
                    <button type='submit' className='md:w-full w-[90vw] mx-auto h-[48px] text-[16px] leading-[16px] rounded-md p-[16px] bg-[#1570EF] text-[#FCFCFD] py-1 font-[600px] mt-[16px]'>
                        Create account
                    </button>
                ...
                {/* End text with Login page Link */}
                <p className='  mx-auto text-[16px] leading-[16px]  text-[#98A2B3]'>
                    Already Have An Account ? 
                    <span className='text-[#1570EF] font-semibold '>
                        <Link to={'/'}>Log in</Link> {/* Link Text for Login Page */}
                    </span>
                </p>
            </div>
